                                   ...
                                   GCancellable        *cancellable)
{
	...
	if (bytes == NULL) {
		...
		old_permissions = gs_flatpak_app_build_permissions_from_metadata (old_keyfile);
		new_permissions = gs_flatpak_app_build_permissions_from_metadata (keyfile);
			     ...
			     GError **error)
{
	...
	permissions = gs_flatpak_app_build_permissions_from_metadata (kf);
