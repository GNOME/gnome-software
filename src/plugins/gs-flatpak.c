			       ...
			       GError **error)
{
	...
	/* default branch */
	default_branch = gs_app_get_default_branch (app);
	if (default_branch != NUL)
		flatpak_remote_set_default_branch (xremote, default_branch);
			     ...
			     GError **error)
{
	...
	if (repo_default_branch != NULL)
		gs_app_set_default_branch (app, repo_default_branch);
