...
typedef enum {
	...
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_UPDATE_SEVERITY	= 1U << 15,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_UPGRADE_REMOVED	= 1U << 16,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_PROVENANCE	= 1U << 17,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_REVIEWS		= 1U << 18,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_REVIEW_RATINGS	= 1U << 19,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_ICON		= 1U << 21,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_PERMISSIONS	= 1U << 22,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_ORIGIN_HOSTNAME	= 1U << 23,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_ORIGIN_UI	= 1U << 24,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_RUNTIME		= 1U << 25,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_SCREENSHOTS	= 1U << 26,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_CATEGORIES	= 1U << 27,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_PROJECT_GROUP	= 1U << 28,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_DEVELOPER_NAME	= 1U << 29,
	GS_PLUGIN_REFINE_REQUIRE_FLAGS_KUDOS		= 1U << 30,
