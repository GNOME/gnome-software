 ...
 **/
typedef enum {
	GS_PLUGIN_REFINE_FLAGS_NONE			= 0U,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_ID		= 1U << 0,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_LICENSE		= 1U << 1,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_URL		= 1U << 2,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_DESCRIPTION	= 1U << 3,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_SIZE		= 1U << 4,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_RATING		= 1U << 5,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_VERSION		= 1U << 6,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_HISTORY		= 1U << 7,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_SETUP_ACTION	= 1U << 8,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_UPDATE_DETAILS	= 1U << 9,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_ORIGIN		= 1U << 10,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_RELATED		= 1U << 11,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_SIZE_DATA	= 1U << 12,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_ADDONS		= 1U << 13,
	GS_PLUGIN_REFINE_FLAGS_ALLOW_PACKAGES		= 1U << 14, /* TODO: move to request */
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_UPDATE_SEVERITY	= 1U << 15,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_UPGRADE_REMOVED	= 1U << 16,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_PROVENANCE	= 1U << 17,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_REVIEWS		= 1U << 18,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_REVIEW_RATINGS	= 1U << 19,
	GS_PLUGIN_REFINE_FLAGS_DISABLE_FILTERING	= 1U << 20,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_ICON		= 1U << 21,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_PERMISSIONS	= 1U << 22,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_ORIGIN_HOSTNAME	= 1U << 23,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_ORIGIN_UI	= 1U << 24,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_RUNTIME		= 1U << 25,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_SCREENSHOTS	= 1U << 26,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_CATEGORIES	= 1U << 27,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_PROJECT_GROUP	= 1U << 28,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_DEVELOPER_NAME	= 1U << 29,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_KUDOS		= 1U << 30,
	GS_PLUGIN_REFINE_FLAGS_REQUIRE_CONTENT_RATING	= 1U << 31,
	GS_PLUGIN_REFINE_FLAGS_MASK			= ~0U,
} GsPluginRefineFlags;
