 ...
 * @get_offline_update_state_async: (nullable): Gets state of an offline update. (Since: 49)
 * @get_offline_update_state_finish: (nullable): Finish method for
 *   @get_offline_update_state_async. Must be implemented if
 *   @get_offline_update_state_async is implemented. (Since: 49)
 * @set_offline_update_action_async: (nullable): Sets an action to do after offline update. (Since: 49)
 * @set_offline_update_action_finish: (nullable): Finish method for
 *   @set_offline_update_action_async. Must be implemented if
 *   @set_offline_update_action_async is implemented. (Since: 49)
 *
